 ...
 * 
 * @class MyJournal.CreateArticlePanel
 * @extends MyJournal.Form.Abstract
 * @param {Object} config An object of configuration properties
 * @xtype myjournal-create-article-panel
 */
MyJournal.CreateArticlePanel = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        layout: 'form'
        ,autoHeight: true
    ...
    MyJournal.CreateArticlePanel.superclass.constructor.call(this,config);    
    this._setup();
};
Ext.extend(MyJournal.CreateArticlePanel, MyJournal.Form.Abstract,{ 
    _init: function(){
        this.form = Ext.getCmp('modx-panel-resource').getForm();
        this.saveButton = Ext.getCmp('save-btn');
    }
...
Ext.reg('myjournal-create-article-panel',MyJournal.CreateArticlePanel);